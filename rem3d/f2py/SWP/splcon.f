     ...
     #                  ncon,icon,con)
Cf2py intent(inout) xlat,xlon,nver,verlat,verlon,verrad
Cf2py intent(out) ncon,icon,con
Cf2py depend(nver) verlat,verlon,verrad,icon,con
      dimension verlat(nver)
      dimension verlon(nver)
      dimension verrad(nver)
      dimension icon(nver)
      dimension con(nver)
c
