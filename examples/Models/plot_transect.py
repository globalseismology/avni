...
def main():
    ...
    if arg.output:
        ...
        outfile = None
    topo,topo_tree,tomo,tomo_tree = plot1section(lat1,lng1,azep,delta,model=model3d,parameter=arg.parameter,
                                                 vmin=-6,vmax=6,colorlabel='$\delta$'+' '+arg.parameter+' / '+arg.parameter+'(%)',
                                                 outfile=outfile,vexaggerate=arg.elev_exxagerate,nelevinter=arg.elev_interval,
                                                 colorcontour=arg.colorcontour,colorpalette=arg.color,radii=[5571,6346.6])
    ...
    if arg.output:
        ...
        outfile = None
    topo,topo_tree,tomo,tomo_tree = plot1section(lat1,lng1,azep,delta,model=model3d,parameter=arg.parameter,
                                                 vmin=arg.lower_bound,vmax=arg.upper_bound,colorlabel='$\delta$'+' '+arg.parameter+' / '+arg.parameter+'(%)',
                                                 outfile=outfile,vexaggerate=arg.elev_exxagerate,nelevinter=arg.elev_interval,
                                                 colorcontour=arg.colorcontour,colorpalette=arg.color)
    ...
    if arg.output:
        ...
        outfile = None
    plot1section(lat1,lng1,azep,delta,topo=topo,topotree=topo_tree,modeltree=tomo_tree,model=tomo,parameter=arg.parameter,
                 vmin=arg.lower_bound,vmax=arg.upper_bound,colorlabel='$\delta$'+' '+arg.parameter+' / '+arg.parameter+'(%)',
                 vexaggerate=arg.elev_exxagerate,nelevinter=arg.elev_interval,outfile=outfile,colorcontour=arg.colorcontour,
                 colorpalette=arg.color)
    ...
    if arg.output:
        ...
        outfile = None
    plot1section(lat1,lng1,azimuth,gcdelta,topo=topo,topotree=topo_tree,modeltree=tomo_tree,model=tomo,parameter=arg.parameter,
                 vmin=arg.lower_bound,vmax=arg.upper_bound,colorlabel='$\delta$'+' '+arg.parameter+' / '+arg.parameter+'(%)',
                 vexaggerate=0,figuresize=[8,4],width_ratios=[1,4],numevalx=360,numevalz=360,outfile=outfile,
                 colorcontour=arg.colorcontour,colorpalette=arg.color)
    ...
    plot1section(lat1,lng1,azimuth,gcdelta,topo=topo,topotree=topo_tree,modeltree=tomo_tree,model=tomo,parameter=arg.parameter,
                 vmin=arg.lower_bound,vmax=arg.upper_bound,colorlabel='$\delta$'+' '+arg.parameter+' / '+arg.parameter+'(%)',
                 vexaggerate=0,figuresize=[8,4],width_ratios=[1,4],numevalx=720,numevalz=720,outfile=outfile,
                 colorcontour=arg.colorcontour,colorpalette=arg.color)
