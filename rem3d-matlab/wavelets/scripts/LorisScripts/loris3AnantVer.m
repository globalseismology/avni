...
if opt<2
  ...
  [hd2,fd2e,gd2,jd2,tt2,rd2,t2,vw2]=loristopo2d('D2',1,8,[],[],[],iface);
  delete(tt2)
end
...
set(ah(length(ah)-2),'xtick',tix2,'xticklabel',round(10*tix2)/10,'xgrid','on')
set(ah(length(ah)-1),'xtick',tix4,'xticklabel',round(10*tix4)/10,'xgrid','on')
set(ah(length(ah)-0),'xtick',tix6,'xticklabel',round(10*tix6)/10,'xgrid','on')
