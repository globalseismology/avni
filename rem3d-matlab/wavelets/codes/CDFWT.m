function f=CDFWT(x,levels,tipe,mr)
% f=ANGULARD2WT(x,[n1 n2],tipe,mr)
%
% Perform CDF wavelet transform in the first two indices of a
...
% 
% Inspired by formatting of Simons' other DNWT scripts
% Anant Hariharan, 7-31-2017
