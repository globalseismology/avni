function varargout=cube2lola(v,ins,eo)
...
% Modified line 26: by Anant Hariharan to ensure x,y,z can have odd/even point
% dependencies.                               7-24-17.

defval('ins',1:6)
defval('eo',0)
% Find the coordinates of the cubed sphere that are being used
[x,y,z]=cube2sphere(nextpow2(size(v,1)),[],[],[],eo);
