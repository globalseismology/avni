...
-   If you do not already have one, you will need to open a free account at <https://github.com>. In order to become a contributor / developer for AVNI, you need to create an account on our [Web site](https://maurya.umd.edu/login/register) and get access rights from us by requesting [here](https://maurya.umd.edu/join-us/github).
