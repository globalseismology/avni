...
.. tab-set::
    ...
    .. tab-item:: Linux
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.3.0/AVNI-1.3.0_0-Linux.sh
            :ref-type: ref
            :color: primary
            :shadow:
    ...
    .. tab-item:: macOS (Intel)
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.3.0/AVNI-1.3.0_0-macOS_Intel.pkg
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3
    ...
    .. tab-item:: macOS (Apple Silicon)
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.3.0/AVNI-1.3.0_0-macOS_M1.pkg
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3
    ...
    .. tab-item:: Windows
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.3.0/AVNI-1.3.0_0-Windows.exe
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3
