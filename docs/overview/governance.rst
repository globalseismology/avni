...
The AVNI software ecosystem (The Project) is designed to be an open source software project. The
goal of The Project is to develop open source software for analysis of
geoscience data in Python. The Project is released under the GNU GPL v3 (or similar) `license
<LICENSE_>`_, developed openly and is hosted publicly under the
``globalseismology`` `GitHub organization <AVNI Github_>`_.
