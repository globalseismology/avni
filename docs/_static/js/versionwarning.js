(function() {
    // adapted 2020-05 from https://mne.tools/versionwarning.js
    if (location.hostname === 'avni.globalseismology.org') {
        ...
        $.ajax({
            type: 'HEAD',
            url: `https://avni.globalseismology.org/stable/${filePath}`,
            error: function() {
                filePath = '';
            },
            complete: function() {
...
//                     }
                    ...
                    $('body').prepend(`${pre}This is documentation for ${verText} of AVNI. <a ${anchor} href="https://avni.globalseismology.org/stable/${filePath}">Switch to stable version</a>${post}`);
                }
            }
        });
    }
