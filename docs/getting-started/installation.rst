...
AVNI is supported on Python versions 3.6+. For the best experience, please
considering using Anaconda as a virtual environment and package manager for
Python and following the instructions to install AVNI with Anaconda.


Dependencies
~~~~~~~~~~~~

AVNI is built on top of NumPy - as such, the following projects are required
dependencies of AVNI:
